...
public class ActiveMQUtil {
    private static final String jmxServiceUrl = "service:jmx:rmi:///jndi/rmi://localhost:11099/jmxrmi";
    private static final String broker = "org.apache.activemq:brokerName=localhost,type=Broker";
