    ...
    static {
        ...
        for( Class clazz : classList ){
            if( !Modifier.isAbstract( clazz.getModifiers() ) ){
                com.sap.ewm.core.annotation.WebSocketHandler handler = (com.sap.ewm.core.annotation.WebSocketHandler) clazz.getAnnotation( com.sap.ewm.core.annotation.WebSocketHandler.class );
