package com.sap.ewm.core.mybatisplus;
...
public class MybatisPlusConfiguration {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.baomidou.mybatisplus.extension.service.impl.ServiceImpl.*(..))";
