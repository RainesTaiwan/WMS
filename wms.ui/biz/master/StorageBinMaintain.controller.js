sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("com.sap.ewm.biz.master.StorageBinMaintain", {

        onInit: function () {
            this.attachPatternMatched("storageBinMaintain", this.onRouteMatched);
        },
        ...
        loadData: function (clear) {
            ...
            var storageBinList = oView.byId("storageBinList");

                storageBinList.load({
                url: "storage-bin/page",
                method: "GET",
                param: {}
            });
        },
        ...
        onSave: function (oEvent) {
            ...
            util.CustomUtil.restfulApiRequest("storage-bin", method, JSON.stringify(param), result => {
                if (result["header"]["code"] != 0) {
                    me.onMessageError(result["header"]["message"]);
                    return;
                }
                MessageToast.show("儲存貨格數據儲存成功");
                me.onShowOneColumn();
                me.loadData(false);
        ...
        onEdit: function (oEvent) {
            ...
            obj["storageBinType"] = this.trimHandle(obj["storageBinTypeBo"]);
            obj["storageLocation"] = this.trimHandle(obj["storageLocationBo"]);
        ...
        onDelete: function (oEvent) {
            ...
            var oDialog = new sap.m.Dialog({
                ...
                beginButton: new sap.m.Button({
                    ...
                    press: function () {
                        util.CustomUtil.restfulApiRequest("storage-bin/" + row.getProperty("handle"), "DELETE", {}, result => {
                            if (result["header"]["code"] != 0) {
                                me.onMessageError(result["header"]["message"]);
                                return;
                            }
        ...
        filterGlobally: function(oEvent) {
            ...
            this.byId("storageBinList").loadAppendParam({"globalQuery" : sQuery});
        },

        clearAllFilters: function(oEvent) {
            this.byId("storageBinList").clearAllFilters();
            this.onRetrieve();
        },
