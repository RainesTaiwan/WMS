sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("com.sap.ewm.biz.master.ResourceTypeMaintain", {

        onInit: function () {
            this.attachPatternMatched("resourceTypeMaintain", this.onRouteMatched);
        },
        ...
        loadData: function (clear) {
            ...
            var resourceTypeList = oView.byId("resourceTypeList");

                resourceTypeList.load({
                url: "resource-type/page",
                method: "GET",
                param: {}
            });
        },
        ...
        onSave: function (oEvent) {
            ...
            util.CustomUtil.restfulApiRequest("resource-type", method, JSON.stringify(param), result => {
                if (result["header"]["code"] != 0) {
                    me.onMessageError(result["header"]["message"]);
                    return;
                }
                MessageToast.show("資源組組數據儲存成功");
                me.onShowOneColumn();
                me.loadData(false);
        ...
        onCreate: function (oEvent) {
            ...
            util.CustomUtil.setFieldFocus(oView, "resourceTypeField", 300);
        ...
        onDelete: function (oEvent) {
            ...
            var oDialog = new sap.m.Dialog({
                ...
                beginButton: new sap.m.Button({
                    ...
                    press: function () {
                        util.CustomUtil.restfulApiRequest("resource-type/" + row.getProperty("handle"), "DELETE", {}, result => {
                            if (result["header"]["code"] != 0) {
                                me.onMessageError(result["header"]["message"]);
                                return;
                            }
        ...
        filterGlobally: function(oEvent) {
            ...
            this.byId("resourceTypeList").loadAppendParam({"globalQuery" : sQuery});
        },

        clearAllFilters: function(oEvent) {
            this.byId("resourceTypeList").clearAllFilters();
            this.onRetrieve();
        },
