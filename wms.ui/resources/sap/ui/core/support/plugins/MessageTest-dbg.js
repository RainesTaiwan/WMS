...
sap.ui.define([
	...
	"use strict";
		...
		function report(oPlugin, smessageType, sMessage, bReceive){
			jQuery(".sapUiSupportMessageCntnt", oPlugin.$()).append("<b style=\"color:" + (bReceive ? "green" : "blue") + ";\">Message '" + smessageType + "' " + (bReceive ? "received" : "send") +
