...
snippet llRemoteDataReply\n\
	llRemoteDataReply(${1:key channel}, ${2:key MESSAGE_TYPE}, ${3:string sdata}, ${4:integer idata});\n\
	$0\n\
...
snippet remote_data\n\
	remote_data(${1:integer event_type}, ${2:key channel}, ${3:key MESSAGE_TYPE}, ${4:string sender}, ${5:integer idata}, ${6:string sdata})\n\
	{\n\
		$0\n\
	}\n\
